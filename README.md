...
**[Download NDF-Inventory-Tracker-Setup-2.0.0.exe](https://github.com/Ashfanndm/ndf-inventory-tracker-build/releases/download/v2.0.0/NDF-Inventory-Tracker-Setup-2.0.0.exe)** (123.38 MB)
...
```powershell
$hash = Get-FileHash -Path "NDF-Inventory-Tracker-Setup-2.0.0.exe" -Algorithm SHA256
$expected = (Get-Content "NDF-Inventory-Tracker-Setup-2.0.0.exe.sha256").Split()[0]
