...
## Latest Release: v2.0.10

**Release Date**: July 12, 2026

### Download

**[Download NDF-Inventory-Tracker-Setup-2.0.10.exe](https://github.com/Ashfanndm/ndf-inventory-tracker-build/releases/download/v2.0.10/NDF-Inventory-Tracker-Setup-2.0.10.exe)** (104.71 MB)
...
```powershell
$hash = Get-FileHash -Path "NDF-Inventory-Tracker-Setup-2.0.10.exe" -Algorithm SHA256
$expected = (Get-Content "NDF-Inventory-Tracker-Setup-2.0.10.exe.sha256").Split()[0]
