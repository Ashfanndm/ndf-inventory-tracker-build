...
**[Download NDF-Inventory-Tracker-Setup-2.0.9.exe](https://github.com/Ashfanndm/ndf-inventory-tracker-build/releases/download/v2.0.9/NDF-Inventory-Tracker-Setup-2.0.9.exe)** (104.71 MB)
...
```powershell
$hash = Get-FileHash -Path "NDF-Inventory-Tracker-Setup-2.0.9.exe" -Algorithm SHA256
$expected = (Get-Content "NDF-Inventory-Tracker-Setup-2.0.9.exe.sha256").Split()[0]
