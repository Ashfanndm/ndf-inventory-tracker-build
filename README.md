...
**[Download NDF-Inventory-Tracker-Setup-2.0.1.exe](https://github.com/Ashfanndm/ndf-inventory-tracker-build/releases/download/v2.0.1/NDF-Inventory-Tracker-Setup-2.0.1.exe)** (123.38 MB)
...
```powershell
$hash = Get-FileHash -Path "NDF-Inventory-Tracker-Setup-2.0.1.exe" -Algorithm SHA256
$expected = (Get-Content "NDF-Inventory-Tracker-Setup-2.0.1.exe.sha256").Split()[0]
