...
## Latest Release: v2.0.17

**Release Date**: September 09, 2026

### Download

**[Download NDF-Inventory-Tracker-Setup-2.0.17.exe](https://github.com/Ashfanndm/ndf-inventory-tracker-build/releases/download/v2.0.17/NDF-Inventory-Tracker-Setup-2.0.17.exe)** (106.46 MB)
...
```powershell
$hash = Get-FileHash -Path "NDF-Inventory-Tracker-Setup-2.0.17.exe" -Algorithm SHA256
$expected = (Get-Content "NDF-Inventory-Tracker-Setup-2.0.17.exe.sha256").Split()[0]
