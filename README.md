...
**[Download NDF-Inventory-Tracker-Setup-1.0.27.exe](https://github.com/Ashfanndm/ndf-inventory-tracker-build/releases/download/v1.0.27/NDF-Inventory-Tracker-Setup-1.0.27.exe)** (123.91 MB)
...
```powershell
$hash = Get-FileHash -Path "NDF-Inventory-Tracker-Setup-1.0.27.exe" -Algorithm SHA256
$expected = (Get-Content "NDF-Inventory-Tracker-Setup-1.0.27.exe.sha256").Split()[0]
